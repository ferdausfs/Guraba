...
object AppConstants {
    const val FLUTTER_METHOD_CHANNEL_FG: String = "com.guraba.app.methodchannel.fg"
    /** Guardian module channel: NSFW filter, PIN, keyword rules, block-event log. */
    const val FLUTTER_METHOD_CHANNEL_GUARDIAN: String = "guraba.guardian"
    const val FLUTTER_METHOD_CHANNEL_BG: String = "com.guraba.app.methodchannel.bg"
    ...
    // Extra intent data
    const val INTENT_EXTRA_IS_SELF_RESTART: String = "com.guraba.app.intent.extra.isSelfRestart"
