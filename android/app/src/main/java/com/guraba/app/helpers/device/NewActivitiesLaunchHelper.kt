...
object NewActivitiesLaunchHelper {
    private const val TAG = "Guraba.ActivityNewTaskHelper"
    ...
    // SECTION: For GURABA app ====================================================================
    /**
     * Gracefully close and restart the app.
     *
     * @param activity The activity to use.
     */
    fun restartGuraba(activity: Activity) {
        ...
        Toast.makeText(activity, "Guraba is restarting", Toast.LENGTH_LONG).show()
    ...
    /**
     * Opens the guraba's notification settings for permission.
     *
     * @param context The context to use for launching the activity.
     */
    fun openGurabaNotificationSection(context: Context) {
