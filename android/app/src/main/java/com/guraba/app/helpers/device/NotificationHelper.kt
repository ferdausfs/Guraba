 ...
 *
 */
package com.guraba.app.helpers.device
...
import com.guraba.app.utils.ThreadUtils.runOnMainThread
...
object NotificationHelper {
    private const val TAG = "Guraba.NotificationHelper"

    // Notification channel IDs
    const val CRITICAL_CHANNEL_ID: String = "guraba.notification.channel.CRITICAL"
    const val FOCUS_CHANNEL_ID: String = "guraba.notification.channel.FOCUS"
    const val BEDTIME_CHANNEL_ID: String = "guraba.notification.channel.BEDTIME"
    const val NOTIFICATION_BATCHING_CHANNEL_ID: String =
        "guraba.notification.channel.NOTIFICATION_BATCHING"
    private const val SERVICE_CHANNEL_ID: String =
        "guraba.notification.channel.SERVICE"
    const val USAGE_REMINDERS_CHANNEL_ID: String = "guraba.notification.channel.USAGE_REMINDERS"
    ...
    fun registerNotificationChannels(context: Context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val criticalChannel = NotificationChannel(
                ...
                description =
                    "These notifications include crucial updates regarding the essential system operations to ensure Guraba runs smoothly."
            }
    ...
    fun buildFgServiceNotification(context: Context, content: String?): Notification {
        return NotificationCompat.Builder(context, SERVICE_CHANNEL_ID)
            ...
            .setContentIntent(AppUtils.getPendingIntentForGurabaUri(context))
