package com.guraba.app.helpers.storage
...
object DriftDbHelper {
    private const val TAG = "Guraba.DriftDbHelper"

    // Open the database if it's not already open
    private fun openDatabase(context: Context): SQLiteDatabase? {
        try {
            // /data/user/0/com.guraba.app/app_flutter/Guraba0.sqlite
            val dbPath = "${context.dataDir.path}/app_flutter/Guraba.sqlite"
