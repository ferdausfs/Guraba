...
import com.guraba.app.helpers.storage.DriftDbHelper
...
class NotificationBatchReceiver : BroadcastReceiver() {
    companion object {
        private const val TAG = "Guraba.NotificationBatchReceiver"
        const val ACTION_PUSH_BATCH: String = "com.guraba.app.action.PushBatch"
        const val EXTRA_NOTIFICATION_SETTINGS_JSON =
            "com.guraba.app.extra.notificationSettingsJson"
    }
    ...
    class NotificationBatchWorker(
        ...
        private fun pushSummeryNotification(unreadNotificationsCount: Int) {
            ...
            val gurabaPendingIntent = AppUtils.getPendingIntentForGurabaUri(
                context,
                "com.guraba.app://open/notifications"
            )
            ...
            val notification = NotificationCompat.Builder(
                ...
                .setContentIntent(gurabaPendingIntent)
                .setContentText(msg)
        ...
        private fun pushAllUnreadNotifications(notifications: List<Notification>) {
            try {
                ...
                val gurabaIntent = AppUtils.getPendingIntentForGurabaUri(
                    context,
                    "com.guraba.app://open/notifications"
                )
