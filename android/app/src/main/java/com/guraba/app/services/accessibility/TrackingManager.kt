...
import com.guraba.app.AppConstants.SYSTEM_UI_PACKAGE
...
class TrackingManager(
    ...
    companion object {
        const val ACTION_ACCESSIBILITY_ACTIVE = "com.guraba.app.action.accessibilityActive"
        const val ACTION_ACCESSIBILITY_INACTIVE = "com.guraba.app.action.accessibilityInactive"
        const val ACTION_NEW_APP_LAUNCHED = "com.guraba.app.action.newAppLaunched"
        const val EXTRA_PACKAGE_NAME: String = "com.guraba.app.extra.packageName"
    }
    ...
    private fun broadcastEvent(action: String, extraPackage: String? = null) {
        try {
            ...
            Log.e(
                "Guraba.Accessibility.TrackingManager",
