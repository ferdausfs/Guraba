 ...
 *
 */
package com.guraba.app.services.notification
...
import com.guraba.app.generics.SmartCacheBox
...
class GurabaNotificationListenerService : NotificationListenerService() {
    companion object {
        private const val TAG = "Guraba.GurabaNotificationService"
    }

    private val binder = ServiceBinder(this@GurabaNotificationListenerService)
    ...
    override fun onListenerDisconnected() {
        ...
        // Try to rebind again
        runCatching {
            val listener = ComponentName(this, GurabaNotificationListenerService::class.java)
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification) {
        ...
        try {
            // If from guraba or not clearable or group summery
            val isGroupSummary =
    ...
    override fun onBind(intent: Intent): IBinder? {
        return if (intent.action == ServiceBinder.ACTION_BIND_TO_GURABA) binder
