...
import com.guraba.app.AppConstants.EMERGENCY_PAUSE_SERVICE_NOTIFICATION_ID
import com.guraba.app.R
import com.guraba.app.generics.SafeServiceConnection
import com.guraba.app.generics.ServiceBinder
import com.guraba.app.helpers.device.NotificationHelper.CRITICAL_CHANNEL_ID
...
class EmergencyPauseService : Service() {
    ...
    override fun onCreate() {
        ...
        mNotificationTimer = NotificationTimer(
            context = this,
            ongoingPendingIntent = AppUtils.getPendingIntentForGurabaUri(this),
    ...
    companion object {
        ...
        private const val TAG = "Guraba.EmergencyPauseService"
    }
}