...
import com.guraba.app.receivers.AccessibilityReceiver
import com.guraba.app.receivers.DeviceLockUnlockReceiver
...
class LaunchTrackingManager(
    ...
    companion object {
        private const val TAG = "Guraba.LaunchTrackingManager"
    ...
    private fun onDeviceUnlocked() {
        ...
        isManualTrackingOn =
            !Utils.isServiceRunning(context, GurabaAccessibilityService::class.java)
