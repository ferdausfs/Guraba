...
import com.guraba.app.enums.RestrictionType
...
import com.guraba.app.utils.GurabaQuotes
...
object OverlayBuilder {
    ...
    fun buildToastOverlay(
        ...
        toastView.setOnClickListener {
            ...
            context.applicationContext.startActivity(
                AppUtils.getIntentForGurabaUri(
                    context,
    ...
    fun buildFullScreenOverlay(
        ...
        val randomQuote = GurabaQuotes.getRandomQuote()
