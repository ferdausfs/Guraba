package com.guraba.app.services.tracking
...
import com.guraba.app.helpers.device.NotificationHelper.USAGE_REMINDERS_CHANNEL_ID
import com.guraba.app.helpers.storage.SharedPrefsHelper
import com.guraba.app.models.RestrictionState
import com.guraba.app.services.accessibility.GurabaAccessibilityService
import com.guraba.app.services.accessibility.GurabaAccessibilityService.Companion.ACTION_PERFORM_HOME_PRESS
import com.guraba.app.services.tracking.OverlayBuilder.getAppLabelAndIcon
...
class OverlayManager(
            ...
            NotificationCompat.Builder(
                ...
                .setContentIntent(
                    AppUtils.getPendingIntentForGurabaUri(
                        context,
                        "com.guraba.app://open/appDashboard?package=$packageName"
                    )
                )
                .build()
        )
    ...
    companion object {
        private const val TAG = "Guraba.OverlayManager"
