package com.guraba.app.workers
...
import com.guraba.app.FgMethodCallHandler
...
class FlutterBgExecutionWorker(
    ...
    companion object {
        private const val TAG = "Guraba.FlutterBgExecutionWorker";
        const val FLUTTER_TASK_ID = "com.guraba.app.flutterTaskId"
    }
