...
import 'package:mindful/ui/screens/guardian/guardian_screen.dart';
...
class AppRoutes {
  ...
  static const String guardianPath = '/guardian';
  ...
  static final Map<String, Widget Function(BuildContext)> routes = {
    ...
    /// Guardian Shield screen
    guardianPath: (context) => GuardianScreen(
          initialTabIndex: context.resolveParam<int>("tab"),
        ),
  };
}
