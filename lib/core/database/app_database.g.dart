...
class $GurabaSettingsTableTable extends GurabaSettingsTable
    with TableInfo<$GurabaSettingsTableTable, GurabaSettings> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $GurabaSettingsTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  late final GeneratedColumnWithTypeConverter<AppThemeMode, int> themeMode =
      GeneratedColumn<int>('theme_mode', aliasedName, false,
          ...
          .withConverter<AppThemeMode>(
              $GurabaSettingsTableTable.$converterthemeMode);
  ...
  late final GeneratedColumnWithTypeConverter<DefaultHomeTab, int>
      defaultHomeTab = GeneratedColumn<int>(
          ...
          .withConverter<DefaultHomeTab>(
              $GurabaSettingsTableTable.$converterdefaultHomeTab);
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'guraba_settings_table';
  @override
  VerificationContext validateIntegrity(Insertable<GurabaSettings> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  GurabaSettings map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GurabaSettings(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}id'])!,
      themeMode: $GurabaSettingsTableTable.$converterthemeMode.fromSql(
          attachedDatabase.typeMapping
      ...
      defaultHomeTab: $GurabaSettingsTableTable.$converterdefaultHomeTab
          .fromSql(attachedDatabase.typeMapping.read(
  ...
  @override
  $GurabaSettingsTableTable createAlias(String alias) {
    return $GurabaSettingsTableTable(attachedDatabase, alias);
  }
...
class GurabaSettings extends DataClass implements Insertable<GurabaSettings> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<int>(id);
    {
      map['theme_mode'] = Variable<int>(
          $GurabaSettingsTableTable.$converterthemeMode.toSql(themeMode));
    }
    ...
    {
      map['default_home_tab'] = Variable<int>($GurabaSettingsTableTable
  ...
  GurabaSettingsTableCompanion toCompanion(bool nullToAbsent) {
    return GurabaSettingsTableCompanion(
      id: Value(id),
  ...
  factory GurabaSettings.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return GurabaSettings(
      id: serializer.fromJson<int>(json['id']),
      themeMode: $GurabaSettingsTableTable.$converterthemeMode
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'themeMode': serializer.toJson<int>(
          $GurabaSettingsTableTable.$converterthemeMode.toJson(themeMode)),
      ...
      'defaultHomeTab': serializer.toJson<int>($GurabaSettingsTableTable
          .$converterdefaultHomeTab
  ...
  GurabaSettings copyWithCompanion(GurabaSettingsTableCompanion data) {
    return GurabaSettings(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('GurabaSettings(')
          ..write('id: $id, ')
...
class GurabaSettingsTableCompanion extends UpdateCompanion<GurabaSettings> {
  final Value<int> id;
  ...
  final Value<String> appVersion;
  const GurabaSettingsTableCompanion({
    this.id = const Value.absent(),
  ...
  GurabaSettingsTableCompanion.insert({
    this.id = const Value.absent(),
    this.themeMode = const Value.absent(),
    this.accentColor = const Value.absent(),
    this.username = const Value.absent(),
  ...
  static Insertable<GurabaSettings> custom({
    Expression<int>? id,
  ...
  GurabaSettingsTableCompanion copyWith(
      {Value<int>? id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (themeMode.present) {
      map['theme_mode'] = Variable<int>($GurabaSettingsTableTable
          .$converterthemeMode
  ...
  @override
  String toString() {
    return (StringBuffer('GurabaSettingsTableCompanion(')
          ..write('id: $id, ')
          ..write('themeMode: $themeMode, ')
          ..write('accentColor: $accentColor, ')
          ..write('username: $username, ')
...
class ParentalControls extends DataClass
  ...
  /// Flag indicating whether to authenticate before opening Guraba or not
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $GurabaSettingsTableTable gurabaSettingsTable =
      $GurabaSettingsTableTable(this);
...
typedef $$FocusSessionsTableTableProcessedTableManager = ProcessedTableManager<
    ...
    FocusSession,
    PrefetchHooks Function()>;
typedef $$GurabaSettingsTableTableCreateCompanionBuilder
    = GurabaSettingsTableCompanion Function({
  Value<int> id,
  Value<AppThemeMode> themeMode,
  Value<String> accentColor,
  Value<String> username,
...
typedef $$GurabaSettingsTableTableUpdateCompanionBuilder
    = GurabaSettingsTableCompanion Function({
  Value<int> id,
  Value<AppThemeMode> themeMode,
  Value<String> accentColor,
...
class $$GurabaSettingsTableTableFilterComposer
    extends Composer<_$AppDatabase, $GurabaSettingsTableTable> {
  $$GurabaSettingsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GurabaSettingsTableTableOrderingComposer
    extends Composer<_$AppDatabase, $GurabaSettingsTableTable> {
  $$GurabaSettingsTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GurabaSettingsTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $GurabaSettingsTableTable> {
  $$GurabaSettingsTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GurabaSettingsTableTableTableManager extends RootTableManager<
    _$AppDatabase,
    $GurabaSettingsTableTable,
    GurabaSettings,
    $$GurabaSettingsTableTableFilterComposer,
    $$GurabaSettingsTableTableOrderingComposer,
    $$GurabaSettingsTableTableAnnotationComposer,
    $$GurabaSettingsTableTableCreateCompanionBuilder,
    $$GurabaSettingsTableTableUpdateCompanionBuilder,
    (
      GurabaSettings,
      BaseReferences<_$AppDatabase, $GurabaSettingsTableTable, GurabaSettings>
    ),
    GurabaSettings,
    PrefetchHooks Function()> {
  $$GurabaSettingsTableTableTableManager(
      _$AppDatabase db, $GurabaSettingsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$GurabaSettingsTableTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$GurabaSettingsTableTableOrderingComposer(
                  $db: db, $table: table),
          createComputedFieldComposer: () =>
...
typedef $$GurabaSettingsTableTableProcessedTableManager
    = ProcessedTableManager<
        _$AppDatabase,
        $GurabaSettingsTableTable,
        GurabaSettings,
        ...
        (
          GurabaSettings,
          BaseReferences<_$AppDatabase, $GurabaSettingsTableTable,
              GurabaSettings>
        ),
        GurabaSettings,
        PrefetchHooks Function()>;
...
class $AppDatabaseManager {
  ...
  $$GurabaSettingsTableTableTableManager get gurabaSettingsTable =>
      $$GurabaSettingsTableTableTableManager(_db, _db.gurabaSettingsTable);
