...
import 'package:guraba/core/services/crash_log_service.dart';
...
import 'package:guraba/initializer.dart';
...
class BgExecutorService {
  ...
  final MethodChannel _methodChannel = const MethodChannel(
    'com.guraba.app.methodchannel.bg',
  );
  ...
  /// if the Guraba app is updated or changed
  ///
  ...
  Future<void> _onMidnightReset() async {
    ...
    final usageHistoryDays =
        (await uniqueDao.loadGurabaSettings()).usageHistoryWeeks * 7;
