...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Fokus auf das wirklich wichtige';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba ist 100% sicher und arbeitet offline. Wir sammeln und speichern keine persönlichen Daten.';
  ...
  String get permission_grant_step_two =>
      '2. Wähle Guraba auf dem nächsten Bildschirm aus.';
  ...
  String get permission_alarms_info =>
      'Bitte erteilen Sie die Erlaubnis zum Einstellen von Alarmen und Erinnerungen. Dadurch kann Guraba Ihre Schlafenszeit pünktlich starten und die App-Timer täglich um Mitternacht zurücksetzen und Ihnen helfen, auf Kurs zu bleiben.';
  ...
  String get permission_usage_info =>
      'Bitte erteilen Sie Zugriffsberechtigung. Dies wird es Guraba ermöglichen, die App-Nutzung zu überwachen und den Zugriff auf bestimmte Apps zu verwalten, wodurch eine fokussiertere und kontrolliertere digitale Umgebung gewährleistet wird.';
  ...
  String get permission_overlay_info =>
      'Bitte erteilen Sie die Berechtigung zum Anzeigen von Overlays. Dadurch kann Guraba beim Öffnen einer pausierten App ein Overlay anzeigen, sodass Sie konzentriert bleiben und Ihren Zeitplan einhalten können.';
  ...
  String get permission_accessibility_info =>
      'Bitte erteilen Sie die Erlaubnis zur Barrierefreiheit. Dadurch kann Guraba den Zugriff auf kurze Videoinhalte (z. B. Reels, Shorts) in Social-Media-Apps und Browsern einschränken und unangemessene Websites filtern.';

  @override
  String get permission_accessibility_required =>
      'Guraba requires accessibility permission to block short content and websites effectively.';

  @override
  String get permission_accessibility_device_tile_label => 'Use Guraba';
  ...
  String get permission_dnd_info =>
      'Please grant Do Not Disturb access. This will allow Guraba to start and stop Do Not Disturb mode during the bedtime schedule.';
  ...
  String get permission_vpn_info =>
      'Bitte erteilen Sie die Berechtigung zum Erstellen einer VPN-Verbindung (Virtual Private Network). Dadurch kann Guraba den Internetzugriff für bestimmte Anwendungen einschränken, indem es ein lokales VPN auf dem Gerät erstellt.';
  ...
  String get permission_notification_access_info =>
      'Bitte erteile die Erlaubnis für den Zugriff auf Benachrichtigungen. Dies ermöglicht Guraba, dir  Benachrichtigungen zu senden.';

  @override
  String get permission_notification_access_required =>
      'Guraba benötigt Zugriff auf Benachrichtigungen, um Benachrichtigungen senden zu können.';
  ...
  String get development_dialog_info =>
      'Guraba is currently under development and may have bugs or incomplete features. If you encounter any issues, please report them to help us improve.\n\nThank you for your feedback!';
  ...
  String get donation_card_info =>
      'Guraba is free and open-source, developed with months of dedication. If it has helped you, your donation would mean the world to us. Every contribution helps us continue improving and maintaining it for everyone.';
  ...
  String get app_restart_dialog_info =>
      'Guraba will automatically restart once the countdown finishes. Please be patient as changes are applied.';
  ...
  String get onboarding_page_one_info =>
      'Pause distracting apps, block short content, and stay on track with customizable focus sessions. Whether you\'re working, studying, or relaxing, Guraba helps you stay in control.';
  ...
  String get onboarding_page_three_info =>
      'Guraba is 100% open-source and operates entirely offline. We don\'t collect or share your personal data — your privacy is guaranteed in every way.';
  ...
  String get onboarding_page_permissions_info =>
      'Guraba requires following essential permissions to track and manage your screen time, helping reduce distractions and improve focus.';
