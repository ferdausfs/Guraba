...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get permission_sheet_privacy_info =>
      'Το Guraba είναι 100% ασφαλές και λειτουργεί εκτός σύνδεσης. Δεν συλλέγουμε ή αποθηκεύουμε προσωπικά δεδομένα.';
  ...
  String get permission_grant_step_two =>
      '2. Επιλέξτε το Guraba στην επόμενη οθόνη.';
  ...
  String get permission_alarms_info =>
      'Παρακαλώ δώσε την άδεια για τον ορισμό ξυπνητηριών και υπενθυμίσεων. Αυτό θα επιτρέψει στο Guraba να ξεκινήσει το πρόγραμμά ύπνου σου στην ώρα του και να επαναφέρει χρονόμετρα εφαρμογών καθημερινά τα μεσάνυχτα και για να σε βοηθήσει να μείνεις στο σωστό δρόμο.';
  ...
  String get permission_usage_info =>
      'Παρακαλούμε εκχώρησε άδεια πρόσβασης χρήσης. Αυτό θα επιτρέψει στο Guraba να παρακολουθεί τη χρήση εφαρμογών και να διαχειρίζεται την πρόσβαση σε ορισμένες εφαρμογές, εξασφαλίζοντας ένα πιο συγκεντρωμένο και ελεγχόμενο ψηφιακό περιβάλλον.';
  ...
  String get permission_overlay_info =>
      'Παρακαλώ παραχώρησε δικαιώματα επικάλυψης οθόνης. Αυτό θα επιτρέψει στο Guraba να δείχνει μια επικάλυψη όταν μια εφαρμογή σε παύση είναι ανοιχτή, βοηθώντας σε να παραμείνεις σε συγκέντρωση και να διατηρήσεις το πρόγραμμά σου.';
  ...
  String get permission_accessibility_info =>
      'Παρακαλούμε εκχώρησε την άδεια προσβασιμότητας. Αυτό θα επιτρέψει στο Guraba να περιορίσει την πρόσβαση σε περιεχόμενο βίντεο μικρής μορφής (πχ. Reels, Shorts) μέσα από εφαρμογές κοινωνικής δικτύωσης και προγράμματα περιήγησης και να φιλτράρει ακατάλληλες ιστοσελίδες.';

  @override
  String get permission_accessibility_required =>
      'Το Guraba απαιτεί δικαιώματα προσβασιμότητας για να μπλοκάρει αποτελεσματικά το σύντομο περιεχόμενο και τις ιστοσελίδες.';

  @override
  String get permission_accessibility_device_tile_label => 'Χρήση Guraba';
  ...
  String get permission_dnd_info =>
      'Παρακαλώ χορήγησε πρόσβαση στη λειτουργία \"Μην ενοχλείτε\". Αυτό θα επιτρέψει στο Guraba να ξεκινήσει και να σταματήσει τη λειτουργία \"Μην ενοχλείτε\" κατά τη διάρκεια του χρονοδιαγράμματος ύπνου.';
  ...
  String get permission_vpn_info =>
      'Παρακαλώ παραχώρησε άδεια για τη δημιουργία σύνδεσης εικονικού ιδιωτικού δικτύου (VPN). Αυτό θα επιτρέψει στο Guraba να περιορίσει την πρόσβαση στο διαδίκτυο για καθορισμένες εφαρμογές με τη δημιουργία τοπικών στη συσκευή VPN.';
  ...
  String get permission_notification_access_info =>
      'Παρακαλούμε χορήγησε άδεια πρόσβασης στις ειδοποιήσεις. Αυτό θα επιτρέψει στο Guraba να οργανώσει τις ειδοποιήσεις σου και να τις παραδίδει βάσει του προγράμματός σου.';

  @override
  String get permission_notification_access_required =>
      'Το Guraba απαιτεί πρόσβαση στις ειδοποιήσεις για να τις οργανώνει και να τις χρονοπρογραμματίζει.';
  ...
  String get development_dialog_info =>
      'Το Guraba είναι υπό ανάπτυξη και μπορεί να έχει σφάλματα ή ελλιπή χαρακτηριστικά. Αν αντιμετωπίσεις οποιοδήποτε πρόβλημα, παρακαλούμε να τα αναφέρεις για να μας βοηθήσεις να βελτιωθούμε.\n\nΣε ευχαριστούμε για τα σχόλιά σου!';
  ...
  String get donation_card_info =>
      'Το Guraba είναι ελεύθερο και ανοικτού κώδικα, που αναπτύχθηκε με μήνες αφοσίωσης. Αν σ\' έχει βοηθήσει, η δωρεά σου θα σήμαινε τα πάντα σε εμάς. Κάθε συνεισφορά μάς βοηθά να συνεχίσουμε να την βελτιώνουμε και να την συντηρούμε για όλους.';
  ...
  String get app_restart_dialog_info =>
      'Το Guraba θα επανεκκινήσει αυτόματα μόλις ολοκληρωθεί η αντίστροφη μέτρηση. Παρακαλώ να κάνεις υπομονή καθώς εφαρμόζονται αλλαγές.';

  @override
  String get accessibility_tip =>
      'Θέλετε έναν πιο έξυπνο, πιο φιλικό προς την μπαταρία αποκλεισμό; Ενεργοποίησε την άδεια προσβασιμότητας για Guraba.';

  @override
  String get battery_optimization_tip =>
      'Το Guraba δεν λειτουργεί; Επιτρέψτε την \'Αγνόηση Βελτιστοποίησης Μπαταρίας\' στις Ρυθμίσεις για να συνεχίσει να λειτουργεί ομαλά.';
  ...
  String get tamper_protection_tip =>
      'Απεγκατάσταση του Guraba; Ενεργοποιήστε το Παράθυρο Απεγκατάστασης για να απενεργοποιήσετε με ασφάλεια την προστασία παραβίασης πρώτα.';
  ...
  String get onboarding_page_one_info =>
      'Παύση ενοχλητικών εφαρμογών, φραγή σύντομου περιεχομένου και παραμονή στο σωστό δρόμο με προσαρμόσιμες συνεδρίες εστίασης. Είτε εργάζεσαι, διαβάζεις είτε χαλαρώνεις το Guraba σε βοηθά να έχεις τον έλεγχο.';
  ...
  String get onboarding_page_three_info =>
      'Το Guraba είναι 100% ανοικτού κώδικα και λειτουργεί εξ\' ολοκλήρου εκτός σύνδεσης. Δεν συλλέγουμε ή κοινοποιούμε τα προσωπικά σου δεδομένα - το απόρρητό σου είναι εγγυημένο με κάθε τρόπο.';
  ...
  String get onboarding_page_permissions_info =>
      'Το Guraba απαιτεί τα ακόλουθα απαραίτητα δικαιώματα για να παρακολουθεί και να διαχειρίζεται το χρόνο επί οθόνης σου, βοηθώντας στη μείωση των περισπασμών και στη βελτίωση της συγκέντρωσης.';
  ...
  String get protected_access_tile_subtitle =>
      'Προστάτεψε το Guraba με το κλείδωμα της συσκευής σου.';
  ...
  String get service_stopping_warning =>
      'Αν το Guraba σταματήσει να λειτουργεί απροσδόκητα, παρακαλώ παραχώρησε την άδεια «Αγνόηση βελτιστοποίησης μπαταρίας» για να το διατηρήσεις σε λειτουργία στο παρασκήνιο. Εάν το θέμα συνεχιστεί, δοκίμασε να βάλεις το Guraba σε λίστα εξαιρέσεων για αδιάλειπτη απόδοση.';

  @override
  String get whitelist_app_tile_title => 'Προσθήκη Guraba σε λίστα εξαιρέσεων';

  @override
  String get whitelist_app_tile_subtitle =>
      'Επέτρεψε στο Guraba να ξεκινάει αυτόματα.';
