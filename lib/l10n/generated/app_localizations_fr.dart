...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Concentrez-vous sur ce qui compte vraiment';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba est 100% sécurisé et fonctionne hors ligne. Nous ne collectons ni stockons aucune donnée personnelle.';
  ...
  String get permission_grant_step_two =>
      '2. Sélectionnez Guraba sur l\'écran suivant.';
  ...
  String get permission_alarms_info =>
      'Veuillez accorder la permission de régler les alarmes et les rappels. Cela permettra à Guraba de démarrer votre horaire de coucher à l\'heure, de réinitialiser les minuteurs de l\'application tous les jours à minuit et de vous aider à rester sur la bonne voie.';
  ...
  String get permission_usage_info =>
      'Veuillez accorder l\'autorisation d\'accès aux données d\'utilisation. Cela permettra à Guraba de surveiller l\'utilisation des applications et de gérer l\'accès à certaines applications, pour un environnement numérique plus contrôlé et propice à la concentration.';
  ...
  String get permission_overlay_info =>
      'Veuillez accorder la permission d\'afficher la superposition. Cela permettra à Guraba d\'afficher une surcouche quand une application en pause est ouverte, ce qui vous aidera à rester concentré et à maintenir votre planning.';
  ...
  String get permission_accessibility_info =>
      'Veuillez accorder l\'autorisation d\'accessibilité. Cela permettra à Guraba de restreindre l\'accès au contenu vidéo court (ex : Reels, Shorts) dans les applications de réseaux sociaux et les navigateurs, et filtrer les sites Web inappropriés.';

  @override
  String get permission_accessibility_required =>
      'Guraba a besoin des permissions d\'accessibilité pour mieux bloquer les sites internet et les formats courts.';

  @override
  String get permission_accessibility_device_tile_label => 'Utiliser Guraba';
  ...
  String get permission_dnd_info =>
      'Veuillez autoriser l\'accès au mode Ne pas déranger. Cela permettra à Guraba de démarrer et d\'arrêter le mode Ne pas déranger pendant l\'horaire du sommeil.';
  ...
  String get permission_vpn_info =>
      'Veuillez accorder la permission de créer une connexion au réseau privé virtuel (VPN). Cela permettra à Guraba de restreindre l\'accès à Internet pour les applications désignées en créant un VPN local sur le périphérique.';
  ...
  String get permission_notification_access_info =>
      'Veuillez accorder l\'autorisation d\'accès aux notifications. Cela permettra à Guraba d\'organiser vos notifications et de les envoyer selon votre planning.';

  @override
  String get permission_notification_access_required =>
      'Guraba nécessite un accès aux notifications pour regrouper et planifier les notifications.';
  ...
  String get development_dialog_info =>
      'Guraba est actuellement en cours de développement et peut avoir des bugs ou des fonctionnalités incomplètes. Si vous rencontrez des problèmes, merci de les signaler pour nous aider à nous améliorer.\n\nMerci pour vos retours !';
  ...
  String get donation_card_info =>
      'Guraba est une application gratuite et open-source, développée avec dévouement durant des mois. Si elle vous a aidé, votre don signifierait beaucoup pour nous. Chaque don nous permet de continuer à l\'améliorer et la maintenir pour tous.';
  ...
  String get app_restart_dialog_info =>
      'Guraba redémarrera automatiquement à la fin du compte à rebours. Merci de patienter le temps que les modifications soient appliquées.';

  @override
  String get accessibility_tip =>
      'Want smarter, more battery-friendly blocking? Enable Accessibility permission for Guraba.';

  @override
  String get battery_optimization_tip =>
      'Guraba not working? Allow \'Ignore Battery Optimization\' in Settings to keep it running smoothly.';
  ...
  String get tamper_protection_tip =>
      'Uninstalling Guraba? Enable the Uninstall Window to safely disable tamper protection first.';
  ...
  String get onboarding_page_one_info =>
      'Que vous travailliez, étudiiez, ou que vous reposiez, Guraba met en pause les distractions et vous permet de garder le contrôle avec des sessions de concentration personnalisables.';
  ...
  String get onboarding_page_three_info =>
      'Guraba est 100% open-source et fonctionne entièrement hors ligne. Nous ne collectons ni ne partageons pas vos données personnelles — votre vie privée est garantie à tous les niveaux.';
  ...
  String get onboarding_page_permissions_info =>
      'Guraba a besoin des autorisations suivantes pour suivre et gérer votre temps d\'écran, vous aider à réduire les distractions et améliorer votre concentration.';
  ...
  String get protected_access_tile_subtitle =>
      'Protect Guraba with your device lock.';
  ...
  String get service_stopping_warning =>
      'If Guraba stops working unexpectedly, please grant the \'Ignore Battery Optimization\' permission to keep it running in the background. If the issue continues, try whitelisting Guraba for uninterrupted performance.';

  @override
  String get whitelist_app_tile_title => 'Whitelist Guraba';

  @override
  String get whitelist_app_tile_subtitle => 'Allow Guraba to auto start.';
  ...
  String get privacy_policy_info =>
      'Guraba is committed to protecting your privacy. We do not collect, store, or transfer any type of user data. The app operates entirely offline and does not require an internet connection, ensuring that your personal information remains private and secure on your device. As a Free and Open Source Software (FOSS) application, Guraba guarantees complete transparency and user control over their data.';
