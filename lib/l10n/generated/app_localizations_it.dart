...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Concentrati sulle cose importanti';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba è sicura al 100% e funziona offline. Nessun dato personale viene raccolto o conservato.';
  ...
  String get permission_grant_step_two =>
      'Seleziona Guraba nella prossima schermata.';

  @override
  String get permission_grant_step_three =>
      'Premi per abilitare Guraba come mostrato qui.';
  ...
  String get permission_alarms_info =>
      'Per favore concedi l\'autorizzazione per l\'impostazione di avvisi e promemoria. Questo permetterà a Guraba di avviare la programmazione notturna e di resettare i timer delle app ogni giorno a mezzanotte.';
  ...
  String get permission_usage_info =>
      'Si prega di concedere il permesso di accesso all\'uso. Questo consentirà a Guraba di monitorare l\'utilizzo delle app e gestire l\'accesso a determinate app, garantendo un ambiente digitale più mirato e controllato.';
  ...
  String get permission_overlay_info =>
      'Please grant display overlay permission. This will allow Guraba to show an overlay when a paused app is opened, helping you stay focused and maintain your schedule.';
  ...
  String get permission_accessibility_info =>
      'Please grant accessibility permission. This will allow Guraba to restrict access to short-form video content (e.g., Reels, Shorts) within social media apps and browsers, and filter inappropriate websites.';
  ...
  @override
  String get permission_accessibility_device_tile_label => 'Usa Guraba';
  ...
  String get permission_vpn_info =>
      'Please grant permission to create virtual private network (VPN) connection. This will enable Guraba to restrict internet access for designated applications by creating local on device VPN.';
  ...
  String get permission_notification_access_info =>
      'Please grant notification access permission. This will allow Guraba to organize your notifications and deliver them on your schedule.';

  @override
  String get permission_notification_access_required =>
      'Guraba requires notification access to batch and schedule notifications.';
  ...
  String get whitelist_app_tile_subtitle =>
      'Permetti a Guraba di avviarsi automaticamente.';
