...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => '本当に大切なことに集中しよう';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba は100%安全で、オフラインでも動作します。個人情報の収集または保存をすることはありません。';
  ...
  @override
  String get permission_grant_step_two => '2. 次の画面で Guraba を選択してください。';
  ...
  String get permission_alarms_info =>
      'Guraba が就寝スケジュールとアプリタイマーを管理できるように、アラームとリマインダーへのアクセスを許可してください。';
  ...
  String get permission_usage_info =>
      'Guraba がアプリの使用状況を把握し、アプリの利用時間を管理できるように、使用状況へのアクセスを許可してください。';
  ...
  String get permission_overlay_info =>
      'Guraba が利用時間を超えたアプリを制限できるように、他のアプリの上に重ねて表示を許可してください。';
  ...
  String get permission_accessibility_required =>
      'Guraba がショートコンテンツやウェブサイトを効果的にブロックするには、ユーザー補助の権限が必要です。';

  @override
  String get permission_accessibility_device_tile_label => 'Guraba の使用';
  ...
  String get permission_dnd_info =>
      'サイレントモードを利用すると、Guraba が就寝時間中の通知を自動的に管理し、快適な睡眠をサポートします。';
  ...
  String get permission_vpn_info =>
      'Guraba がアプリのインターネットアクセスを制限するために、仮想プライベートネットワーク（VPN）接続の作成を許可してください。';
  ...
  String get permission_notification_access_info =>
      '通知へのアクセス権限を許可してください。これにより、Guraba が通知を整理し、あなたのスケジュールに合わせて通知を配信できるようになります。';

  @override
  String get permission_notification_access_required =>
      'Guraba が通知をまとめてスケジュール配信するには、通知へのアクセス権限が必要です。';
  ...
  String get development_dialog_info =>
      'Gurabaは現在開発中のため、不具合や未完成の機能がある可能性があります。 問題が発生した場合は、改善のためご報告ください。\n\nご意見ありがとうございます！';
  ...
  String get donation_card_info =>
      'Guraba は、数ヶ月の開発期間を経て、無料で公開しています。このアプリをより多くの人々に届け、改善し続けるために、皆様からの温かいご支援をお待ちしています。';
  ...
  String get app_restart_dialog_info =>
      'カウントダウン終了後、Guraba は自動的に再起動します。変更の適用には少し時間がかかりますので、お待ちください。';
  ...
  String get battery_optimization_tip =>
      'Guraba が予期せず停止する場合は、「設定>詳細設定」から「バッテリー最適化を無視する」権限を付与して、バックグラウンドでの動作を継続させることを検討してください。';
  ...
  String get onboarding_page_one_info =>
      'Guraba で集中力をマスターしましょう。気が散るアプリやショートコンテンツをブロックし、あなただけの集中時間を作り出します。';
  ...
  String get onboarding_page_three_info =>
      'Guraba は、あなたのプライバシーを最優先に考えています。アプリは100%オープンソースで、オフラインで動作するため、個人情報は一切収集されません。';
  ...
  String get onboarding_page_permissions_info =>
      'Guraba が画面の使用時間を追跡・管理し、集中力を高めるために必要な権限は以下のとおりです。';
  ...
  @override
  String get protected_access_tile_subtitle => 'デバイスロックで Guraba を保護する';
  ...
  String get service_stopping_warning =>
      'Gurabaが予期せず動作を停止した場合は、バッテリーの最適化を無視することを許可し、バックグラウンドで実行できるようにしてください。それでも問題が続く場合は、Gurabaを許可リストに登録して、動作を中断されないようにしてください。';

  @override
  String get whitelist_app_tile_title => 'Guraba を許可リストに追加';

  @override
  String get whitelist_app_tile_subtitle => 'Gurabaの自動起動を有効にする';
  ...
  String get privacy_policy_info =>
      'Gurabaはプライバシー保護に最優先で取り組んでいます。ユーザーデータの収集、保存、または第三者に提供することはありません。アプリは完全にオフラインで動作し、インターネット接続を必要としないため、ユーザーの個人情報はデバイス上で安全に保護されます。無料でオープンソースのソフトウェア（FOSS）であり、完全な透明性とユーザーによるデータの制御を保証します。';
