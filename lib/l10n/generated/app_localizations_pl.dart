...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Skup się na tym, co naprawdę ważne';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba jest w 100% bezpieczny i działa offline. Nie zbieramy ani nie przechowujemy żadnych danych osobowych.';
  ...
  String get permission_grant_step_two =>
      '2. Wybierz Guraba na następnym ekranie.';
  ...
  String get permission_alarms_info =>
      'Proszę udzielić pozwolenia na ustawianie alarmów i przypomnień. Dzięki temu Guraba będzie mógł rozpocząć Twój harmonogram snu na czas i resetować timery aplikacji codziennie o północy, co pomoże Ci utrzymać się na właściwej drodze.';
  ...
  String get permission_usage_info =>
      'Proszę udzielić pozwolenia na dostęp do danych o użyciu. Pozwoli to Guraba monitorować użytkowanie aplikacji i zarządzać dostępem do niektórych aplikacji, zapewniając bardziej skoncentrowane i kontrolowane środowisko cyfrowe.';
  ...
  String get permission_overlay_info =>
      'Proszę udzielić pozwolenia na wyświetlanie nakładki. Umożliwi to Guraba wyświetlanie nakładki po otwarciu wstrzymanej aplikacji, co pomoże Ci zachować koncentrację i utrzymać harmonogram.';
  ...
  String get permission_accessibility_info =>
      'Proszę udzielić zezwolenia na dostępność. Pozwoli to Guraba ograniczyć dostęp do krótkich treści wideo (np. Reels, Shorts) w aplikacjach mediów społecznościowych i przeglądarkach oraz filtrować nieodpowiednie witryny.';
  ...
  @override
  String get permission_accessibility_device_tile_label => 'Używaj Guraba';
  ...
  String get permission_vpn_info =>
      'Proszę przyznać uprawnienia do tworzenia połączenia wirtualnej sieci prywatnej (VPN). Umożliwi to Guraba ograniczenie dostępu do internetu dla wyznaczonych aplikacji poprzez tworzenie lokalnych sieci VPN na urządzeniu.';
