...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Concentre-se no que realmente importa';
  ...
  String get permission_sheet_privacy_info =>
      'O Guraba é 100% seguro e funciona offline. Não recolhemos nem armazenamos quaisquer dados pessoais.';
  ...
  String get permission_grant_step_two =>
      '2. Selecione Guraba na próxima tela.';
  ...
  String get permission_alarms_info =>
      'Por favor, conceda permissão para definir alarmes e lembretes. Isso permitirá que o Guraba inicie sua programação de hora de dormir a tempo e redefina os cronômetros do aplicativo diariamente à meia-noite e ajude você a ficar no caminho certo.';
  ...
  String get permission_usage_info =>
      'Por favor, conceda permissão de acesso ao uso. Isso permitirá que a Guraba monitore o uso de aplicativos e gerencie o acesso a determinados aplicativos, garantindo um ambiente digital mais focado e controlado.';
  ...
  String get permission_overlay_info =>
      'Por favor, conceda permissão de sobreposição de tela. Isso permitirá que o Guraba mostre uma sobreposição quando um aplicativo pausado é aberto, ajudando você a manter o foco e manter sua agenda.';
  ...
  String get permission_accessibility_info =>
      'Por favor, conceda permissão de acessibilidade. Isso permitirá que o Guraba restrinja o acesso ao conteúdo de vídeo curto (por exemplo, Reels, Shorts) dentro dos aplicativos e navegadores de mídia social e filtre sites inadequados.';

  @override
  String get permission_accessibility_required =>
      'Guraba requer permissão de acessibilidade para bloquear conteúdo curto e websites de forma eficaz.';
  ...
  String get permission_dnd_info =>
      'Por favor, conceda acesso a Não Perturbe. Isso permitirá que o Guraba inicie e pare o modo Não Perturbe durante a programação da hora de dormir.';
  ...
  String get permission_vpn_info =>
      'Por favor, conceda permissão para criar uma conexão de rede privada virtual (VPN). Isso permitirá que o Guraba restrinja o acesso à internet para aplicativos designados, criando uma VPN local no dispositivo.';
  ...
  String get permission_notification_access_info =>
      'Conceda permissão de acesso à notificação. Isso permitirá que Guraba  organize suas notificações e leva-las em sua agenda.';

  @override
  String get permission_notification_access_required =>
      'Guraba requer acesso a notificações para agrupar e agendar notificações.';
  ...
  String get development_dialog_info =>
      'Guraba está atualmente em desenvolvimento e pode ter bugs ou recursos incompletos. Se você encontrar algum problema, por favor informe-os para nos ajudar a melhorar. Obrigado pelo seu feedback!';
  ...
  String get donation_card_info =>
      'Guraba é de graça e de código aberto, desenvolvido com meses de dedicação. Se isso ajudou você, sua doação significaria o mundo para nós. Toda contribuição nos ajudam continuar melhorando e revisando isso para todos.';
  ...
  String get app_restart_dialog_info =>
      'Guraba será reiniciado automaticamente quando a contagem regressiva terminar. Por favor, seja paciente como as mudanças são aplicadas.';

  @override
  String get accessibility_tip =>
      'Quer um bloqueio mais inteligente e amigável à bateria? Ative a permissão de acessibilidade para o Guraba.';

  @override
  String get battery_optimization_tip =>
      'Guraba não está funcionando? Permitir \'Ignorar Otimização da bateria\' nas Configurações para mantê-lo funcionando sem problemas.';
  ...
  String get tamper_protection_tip =>
      'Desinstalar o Guraba? Habilite a Janela de Desinstalação para desativar a proteção de desinstalação com segurança primeiro.';
  ...
  String get onboarding_page_one_info =>
      'Pause apps que distraem, bloqueie conteúdo curto e mantenha-se no caminho certo com sessões de foco personalizáveis. Se você está trabalhando, estudando ou relaxando, Guraba ajuda você a ficar no controle.';
  ...
  String get onboarding_page_three_info =>
      'A Guraba é 100% open-source e opera totalmente offline. Não recolhemos nem partilhamos os seus dados pessoais — a sua privacidade está garantida de todas as formas.';
  ...
  String get onboarding_page_permissions_info =>
      'O Guraba requer as seguintes permissões essenciais para rastrear e gerenciar seu tempo de tela, ajudando a reduzir distrações e melhorar o foco.';
  ...
  String get protected_access_tile_subtitle =>
      'Proteja Guraba com o bloqueio do seu dispositivo.';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      'Uma vez ativado, você não poderá desinstalar, forçar parada ou limpar os dados do Guraba, exceto durante a janela de desinstalação selecionada. Não há soluções alternativas.\n\nProssiga por sua conta e risco.';
  ...
  String get service_stopping_warning =>
      'Se o Guraba parar de funcionar inesperadamente, por favor, conceda a permissão \'Ignorar Otimização de bateria\' para mantê-lo em execução em segundo plano. Se o problema continuar, tente incluir o Guraba na lista de permissões para um desempenho ininterrupto.';

  @override
  String get whitelist_app_tile_title =>
      'Colocar Guraba na lista de permissões';

  @override
  String get whitelist_app_tile_subtitle =>
      'Permitir que o Guraba inicie automaticamente.';
  ...
  String get privacy_policy_info =>
      'A Guraba está empenhado em proteger a sua privacidade. Não recolhemos, armazenamos ou transferimos qualquer tipo de dados do usuário. O aplicativo funciona totalmente offline e não requer uma conexão com a Internet, garantindo que suas informações pessoais permaneçam privadas e seguras em seu dispositivo. Como um aplicativo de software livre e de código aberto (FOSS), o Guraba garante total transparência e controle do usuário sobre seus dados.';
