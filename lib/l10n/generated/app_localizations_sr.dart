...
class AppLocalizationsSr extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Фокусирај се на оно што је заиста важно';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba је 100% сигуран и ради ван мреже. Не прикупљамо, нити чувамо било какве личне податке.';
  ...
  String get permission_grant_step_two =>
      '2. Изабери Guraba на следећем екрану.';
  ...
  String get permission_alarms_info =>
      'Молимо те да одобриш дозволу за постављање аларма и подсећања. Ово ће омогућити Guraba да на време започне твој распоред за спавање. Такође, апликација ће дневно ресетовати тајмере у поноћ и помоћи ти да останеш на правом путу.';
  ...
  String get permission_usage_info =>
      'Молимо дозволите приступ подацима о коришћењу. Ово ће омогућити да Guraba прати употребу апликација и управља приступом одређеним апликацијама, обезбеђујући фокусираније и контролисаније дигитално окружење.';
  ...
  String get permission_accessibility_info =>
      'Молимо одобрите дозволу за приступачност. Ово ће омогућити апликацији Guraba да ограничи приступ кратком видео садржају (нпр. Reels, Shorts) у оквиру апликација друштвених мрежа и интернет прегледача, као и да филтрира непримерене веб-сајтове.';

  @override
  String get permission_accessibility_required =>
      'Guraba захтева дозволу за приступачност како би ефикасно блокирао кратки садржај и веб-сајтове.';

  @override
  String get permission_accessibility_device_tile_label => 'Користи Guraba';
  ...
  String get permission_dnd_info =>
      'Дозволи приступ за режим „Не ометај“. Ово ће омогућити Guraba да покрене и заустави режим „Не ометај“ током распореда за спавање.';
  ...
  String get permission_vpn_info =>
      'Одобри дозволу за креирање виртуелне приватне мреже (VPN). Ово ће омогућити апликацији Guraba да ограничи приступ интернету за одређене апликације креирањем локалне VPN мреже на уређају.';
  ...
  String get permission_notification_access_info =>
      'Молимо те да одобриш дозволу за приступ обавештењима. Ово ће омогућити Guraba да организује твоја обавештења и достави их по твом распореду.';

  @override
  String get permission_notification_access_required =>
      'Апликација Guraba захтева приступ обавештењима како би груписао и заказивао обавештења.';
  ...
  String get development_dialog_info =>
      'Guraba је тренутно у развоју и могуће је да садржи грешке или непотпуне функције. Ако наиђеш на проблем, пријави га како бисмо могли да побољшамо апликацију.\n\nХвала на повратним информацијама!';
  ...
  String get donation_card_info =>
      'Guraba је бесплатна апликација отвореног кода, развијана месецима уз велику посвећеност. Ако ти је била од помоћи, донација би нам значила пуно. Сваки допринос нам помаже да наставимо са унапређивањем и одржавањем апликације за све.';
  ...
  String get app_restart_dialog_info =>
      'Guraba ће се аутоматски поново покренути када се одбројавање заврши. Молимо за стрпљење док се измене примењују.';

  @override
  String get accessibility_tip =>
      'Желиш паметније блокирање које троши мање батерије? Одобри дозволу за приступачност за апликацију Guraba да би све радило боље и ефикасније.';

  @override
  String get battery_optimization_tip =>
      'Guraba не ради како треба?\nДозволи „Игнориши оптимизацију батерије“ у подешавањима како би Guraba несметано радио у позадини.';
  ...
  String get glance_usage_tip =>
      'Желиш увид у своје навике?\nGuraba нуди одељак преглед где можеш да сазнаш како проводиш време на телефону.';

  @override
  String get tamper_protection_tip =>
      'Желиш да деинсталираш Guraba? Прво укључи прозор за деинсталацију да би безбедно искључио заштиту од уклањања.';

  @override
  String get notification_blocking_tip =>
      'Желиш мање ометања? Guraba ти нуди опцију блокирања обавештења како би утишао жељене апликације.';
  ...
  String get onboarding_page_one_info =>
      'Паузирај апликације које те ометају, блокирај кратак садржај и остани фокусиран уз флексибилне фокус сесије. Без обзира да ли радиш, учиш или се одмараш, Guraba ти помаже да задржиш контролу.';
  ...
  String get onboarding_page_three_info =>
      'Guraba је у 100% отвореног кода и ради потпуно офлајн. Не прикупљамо нити делимо било какве личне податке — твоја приватност је у потпуности загарантована.';
  ...
  String get onboarding_page_permissions_info =>
      'Guraba захтева следеће основне дозволе како би могао да прати и управља временом проведеним испред екрана, смањи ометања и побољша фокус.';
  ...
  String get protected_access_tile_subtitle =>
      'Заштити апликацију Guraba помоћу закључавања уређаја.';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      'Када буде омогућено, нећеш моћи да деинсталираш, принудно зауставиш или очистиш податке апликације Guraba, осим током изабраног периода за деинсталацију. Нема заобилазних решења.\n\nНастави на своју одговорност.';
  ...
  String get service_stopping_warning =>
      'Ако Guraba престане да ради изненада, молимо те да доделиш дозволу \'Игнориши оптимизацију батерије\' како би апликација наставила да ради у позадини. Ако то не реши проблем, покушај да ставиш Guraba на белу листу за неометан рад.';

  @override
  String get whitelist_app_tile_title => 'Додај Guraba на белу листу';

  @override
  String get whitelist_app_tile_subtitle =>
      'Одобри да се Guraba аутоматски покреће.';
