...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Сфокусуйтесь на тому, що дійсно має значення';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba є на 100 % безпечним і працює в автономному режимі. Ми не збираємо або зберігаємо жодні персональні дані.';
  ...
  String get permission_grant_step_two =>
      '2. Оберіть Guraba на наступному екрані.';
  ...
  String get permission_alarms_info =>
      'Будь ласка, дозвольте налаштування будильників та нагадувань. Це надасть можливість Guraba встановлювати ваш режим сну вчасно і щоденно скидати о півночі таймери застосунку, та допомогти вам залишитись на шляху.';
  ...
  String get permission_usage_info =>
      'Будь ласка, дозвольте збирати статистику використання. Це надасть можливість Guraba контролювати використання застосунку та управляти доступом до певних застосунків, забезпечити більш сфокусоване та контрольоване цифрове середовище.';
  ...
  String get permission_overlay_info =>
      'Будь ласка, дозвольте нашарування. Це надасть можливість Guraba показувати нашарування, коли застосунок є на паузі, допомагаючи вам залишатись у фокусі та підтримувати свій графік.';
  ...
  String get permission_accessibility_info =>
      'Будь ласка, дозвольте обмеження доступу. Це надасть можливість Guraba обмежувати дозвіл до короткого відеоконтенту (наприклад, Reels, Shorts) у застосунках соцмереж і браузерах, та фільтрувати недоречні вебсайти.';

  @override
  String get permission_accessibility_required =>
      'Guraba потребує дозвіл на обмеження доступу для ефективного блокування контенту та вебсайтів.';
  ...
  String get permission_dnd_info =>
      'Будь ласка, дозвольте режим \"Не турбувати\". Це надасть можливість Guraba починати та закінчувати режим \"Не турбувати\" протягом режиму сну.';
  ...
  String get permission_vpn_info =>
      'Будь ласка, дозвольте створення підключення віртуальної приватної мережі (VPN). Це надасть можливість Guraba обмежити доступ для призначених застосунків, створюючи локальну мережу VPN.';
  ...
  String get permission_notification_access_info =>
      'Будь ласка, дозвольте сповіщення. Це надасть можливість Guraba організувати сповіщення та надсилати їх за вашим розкладом.';

  @override
  String get permission_notification_access_required =>
      'Guraba потребує доступ до сповіщень для того, щоб збирати в пакети та планувати сповіщення.';
  ...
  String get development_dialog_info =>
      'Guraba перебуває зараз в процесі розробки і може містити помилки чи незакінчені функції. Якщо ви стикаєтесь з будь-якими проблемами, буль ласка, повідомте про них, щоб допомогти нам у покращенні.\n\nДякуємо за ваш відгук!';
  ...
  String get donation_card_info =>
      'Guraba є безплатний та відкритий, розроблений з відданістю протягом місяців. Якщо застосунок вам допоміг, ваша пожертва буде безмежно цінною для нас. Кожен внесок нам допомагає вдосконалювати для підтримувати застосунок для кожного.';
  ...
  String get app_restart_dialog_info =>
      'Guraba буде автоматично перезапущений після завершення зворотного відліку. Будь ласка, будьте терплячі, оскільки будуть застосовані зміни.';

  @override
  String get accessibility_tip =>
      'Хочете розумніше, більш зручне для батареї блокування? Надайте дозвіл на спеціальні можливості для Guraba.';

  @override
  String get battery_optimization_tip =>
      'Guraba не працює? Дозвольте \"Ігнорування оптимізації батареї\" в Налаштуваннях, щоб підтримувати безперебійну роботу.';
  ...
  String get tamper_protection_tip =>
      'Видалити Guraba? Спершу увімкніть Вікно Видалення для безпечного вимкнення захисту від несанкціонованого доступу.';
  ...
  String get onboarding_page_one_info =>
      'Призупиніть відволікаючі застосунки, блокуйте короткий контент та залишайтесь у фокусі з налаштованими сесіями зосередження. Незалежно від того, чи ви працюєте, навчаєтесь або відпочиваєте, Guraba допомагає вам зберігати контроль.';
  ...
  String get onboarding_page_three_info =>
      'Guraba є на 100 % з відкритим вихідним кодом і повністю працює в автономному режимі. Ми не збираємо і не передаємо ваші персональні дані — ваша конфіденційність гарантується будь-яким чином.';
  ...
  String get onboarding_page_permissions_info =>
      'Guraba вимагає забезпечення необхідних дозволів для відстежування та управління екранним часом, допомагаючи зменшити відволікання та покращити фокусування.';
  ...
  String get protected_access_tile_subtitle =>
      'Захистіть Guraba за допомогою блокування вашого пристрою.';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      'Після ввімкнення ви не зможете видалити, примусово зупинити або очистити дані Guraba, окрім як у вибраному вікні видалення. Обхідних шляхів немає.';
  ...
  String get service_stopping_warning =>
      'Якщо Guraba несподівано перестає працювати, надайте дозвіл \"Ігнорувати оптимізацію заряду батареї\", щоб програма продовжувала працювати у фоновому режимі. Якщо проблема не зникне, спробуйте додати Guraba до білого списку для безперебійної роботи.';

  @override
  String get whitelist_app_tile_title => 'Додати Guraba до білого списку';

  @override
  String get whitelist_app_tile_subtitle =>
      'Дозволити автоматичний запуск для Guraba.';
