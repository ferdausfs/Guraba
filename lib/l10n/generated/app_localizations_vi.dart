...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get guraba_tagline => 'Tập trung vào những gì thực sự quan trọng';
  ...
  String get permission_sheet_privacy_info =>
      'Guraba an toàn 100% và hoạt động ngoại tuyến. Chúng tôi không thu thập hoặc lưu trữ bất kỳ dữ liệu cá nhân nào.';
  ...
  String get permission_grant_step_two =>
      '2. Chọn Guraba ở màn hình tiếp theo.';
  ...
  String get permission_alarms_info =>
      'Vui lòng cấp quyền cài đặt báo thức và nhắc nhở. Điều này sẽ cho phép Guraba bắt đầu lịch trình đi ngủ đúng giờ và đặt lại bộ hẹn giờ ứng dụng hàng ngày vào lúc nửa đêm và giúp bạn duy trì đúng tiến độ.';
  ...
  String get permission_usage_info =>
      'Please grant usage access permission. This will allow Guraba to monitor app usage and manage access to certain apps, ensuring a more focused and controlled digital environment.';
  ...
  @override
  String get permission_accessibility_device_tile_label => 'Sử dụng Guraba';
