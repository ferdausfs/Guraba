...
import 'package:guraba/models/permissions_model.dart';
...
import 'package:guraba/ui/onboarding/permission_page.dart';
...
class _OnboardingState extends ConsumerState<OnboardingScreen> {
  ...
  void _finishOnboarding() async {
    if (mounted) {
      ref.read(gurabaSettingsProvider.notifier).markOnboardingDone();
