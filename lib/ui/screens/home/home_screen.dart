...
import 'package:mindful/core/services/method_channel_service.dart';import 'package:mindful/config/app_constants.dart';
...
class _GuardianButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      tooltip: 'Guardian Shield',
      icon: const Icon(FluentIcons.shield_20_filled),
      onPressed: () =>
          Navigator.of(context).pushNamed(AppRoutes.guardianPath),
    );
  }
}
