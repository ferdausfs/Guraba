...
import 'package:guraba/ui/dialogs/time_countdown_dialog.dart';
...
class _ImportExportDbState extends ConsumerState<ImportExportDb> {
  ...
  void _exportDatabase() async {
    try {
      ...
      /// Get the database path: /data/user/0/com.guraba.app/app_flutter/Guraba.sqlite
      ...
      final gurabaVersionCode = MethodChannelService
          .instance.deviceInfo.gurabaVersion
          .split("+")
          .lastOrNull;

      final resultPath = await FilePicker.platform.saveFile(
        fileName:
            "Guraba_v${gurabaVersionCode}_dbv${dbVersionCode}_$timeStamp.sqlite",
